...
BCUpdate=["BC1", "BC2", "UC1", "FogRemix2"]
Branches=[Central, Dawn, Storm, Day, Night, Remix, Fog, Defiance, BCUpdate]
...
"Night4":"My Regrets","Stratos1":"Remix 1","Stratos2":"Remix 2","Stratos3":"Remix 3","FogRemix1":"Fog Remix 1",\
...
"BC1":"Battle challenge 1", "BC2" : "Battle challenge 2", "UC1" : "Kalifen's UC", "FogRemix2" : "For Remix 2"}
...
bcucheck = Checkbutton(f1, text="BC Update", anchor="w", variable=bcupdate)
bcucheck.pack(fill=BOTH, expand=1)
centralcheck.select()
dawncheck.select()
stormcheck.select()
daycheck.select()
